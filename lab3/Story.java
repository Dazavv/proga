...
public class Story {
    public static void main(String[] args) {
        ...
        System.out.print(atThisTime + truck.makeNoise() + " " + neznaika.see(null) + ", что " + truck.pullUp(stack.beWooly()) + "\n"
                ...
                + instantly + " " + neznaika.setName("ему") + neznaika.remember("рассказы") + " о том, что " + shorties.beHappened(wackyIsland.getName()) + "\n"
